 ...
 * @icon fa fa-circle-o
 */
class ProductGrade extends Backend
{
    
    /**
     * ProductGrade模型对象
     * @var \app\admin\model\ProductGrade
     */
     ...
     public function index()
     {
         ...
         if ($this->request->isAjax()) {
             ...
             for($i=0;$i<count($list);$i++){
                 ...
                 $list[$i]['reviser_name'] = Db::table('fa_admin')->where('id',$list[$i]['reviser'])->value('name');
             }
