define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'product_size/index' + location.search,
                    add_url: 'product_size/add',
                    edit_url: 'product_size/edit',
                    del_url: 'product_size/del',
                    multi_url: 'product_size/multi',
                    table: 'product_size',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'size_name', title: __('Size name'), operate: 'LIKE %...%'},
