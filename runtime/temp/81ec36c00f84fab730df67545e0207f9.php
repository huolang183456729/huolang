<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\phpstudy_pro\WWW\zserp\public/../application/admin\view\auth\admin\edit.html";i:1601273008;s:68:"D:\phpstudy_pro\WWW\zserp\application\admin\view\layout\default.html";i:1588765311;s:65:"D:\phpstudy_pro\WWW\zserp\application\admin\view\common\meta.html";i:1600322607;s:67:"D:\phpstudy_pro\WWW\zserp\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('用户角色'); ?>:</label>
    ...
    <div class="form-group">
        <label for="username" class="control-label col-xs-12 col-sm-2"><?php echo __('用户姓名'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
    ...
    <div class="form-group">
        <label for="nickname" class="control-label col-xs-12 col-sm-2"><?php echo __('英文名'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-country" data-rule="required" data-source="warehouse_management/get_country" data-field="cn_name" data-primaryKey="id" class="form-control selectpage"   name="row[country]"  type="text"  value="<?php echo htmlentities($row['country']); ?>">
        </div>
    </div>

    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('组织机构'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[organization_id]', $channeldata, $row['organization_id'], ['class'=>'form-control', 'required'=>'']); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[status]', ['normal'=>__('Normal'), 'disabled'=>__('Disabled')], $row['status']); ?>
        </div>
    </div>
